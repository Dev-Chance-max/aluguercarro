...
CREATE TABLE `alugueis` (
  ...
  CONSTRAINT `alugueis_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`),
  CONSTRAINT `alugueis_ibfk_2` FOREIGN KEY (`carro_id`) REFERENCES `carros` (`id`)
...
INSERT INTO `alugueis` VALUES (1,1,1,'2024-10-02','2024-10-02','ativo'),(2,5,5,'2024-10-02','2024-10-02','ativo');
...
-- Dump completed on 2024-12-28 14:49:23
